...
{
    [TestFixture]
    public class AddRacerCommandTests
    {
        [Test]
        public void ConstructorShouldThrow_WhenInvalidMainUnitOfWorkIsProvided()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new AddRacerCommand(mainUnitOfWorkStub, writerStub.Object, modelFactoryStub.Object));
        }
        ...
        public void ConstructorShouldThrow_WhenInvalidWriterIsProvided()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new AddRacerCommand(mainUnitOfWorkStub.Object, writerStub, modelFactoryStub.Object));
        }
        ...
        public void ConstructorShouldThrow_WhenInvalidModelFactoryIsProvided()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new AddRacerCommand(mainUnitOfWorkStub.Object, writerStub.Object, modelFactoryStub));
        }
        ...
        public void ConstructorShouldNotThrow_WhenAllParametersAreValid()
        {
            ...
            Assert.DoesNotThrow(() => new AddRacerCommand(mainUnitOfWorkStub.Object, writerStub.Object, modelFactoryStub.Object));
