...
{
    [TestFixture]
    public class AddTrackCommandTests
    {
        ...
        public void ConstructorShouldThrow_WhenInvalidMainUnitOfWorkIsProvided()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new AddTrackCommand(mainUnitOfWorkStub, writerStub.Object, modelFactoryStub.Object));
        }
        ...
        public void ConstructorShouldThrow_WhenInvalidWriterIsProvided()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new AddTrackCommand(mainUnitOfWorkStub.Object, writerStub, modelFactoryStub.Object));
        }
        ...
        public void ConstructorShouldThrow_WhenInvalidModelFactoryIsProvided()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new AddTrackCommand(mainUnitOfWorkStub.Object, writerStub.Object, modelFactoryStub));
        }
        ...
        public void ConstructorShouldNotThrow_WhenAllParametersAreValid()
        {
            ...
            Assert.DoesNotThrow(() => new AddTrackCommand(mainUnitOfWorkStub.Object, writerStub.Object, modelFactoryStub.Object));
