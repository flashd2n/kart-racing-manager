...
{
    public class GetRacerInformationCommand : ICommand
    {
        private readonly IMainUnitOfWork mainUnitOfWork;
        private readonly IWriter writer;

        public GetRacerInformationCommand(IMainUnitOfWork mainUnitOfWork, IWriter writer)
        {
        ...
        public void Execute(params string[] commandParameters)
        {
            ...
            {
                this.writer.Write("GetRacerInformation racer_id");
